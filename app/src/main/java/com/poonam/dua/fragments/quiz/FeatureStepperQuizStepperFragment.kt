package com.poonam.dua.fragments.quiz
...
class FeatureStepperQuizStepperFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_stepper_quiz_stepper_fragment, container, false)
...
//        }
    ...
    private fun setHightLight(view: View) {
        if (correctAnswer == selectedAnswer) {
            view.setBackgroundColor(ContextCompat.getColor(context!!,R.color.green_50))
        } else {
            view.setBackgroundColor(ContextCompat.getColor(context!!,R.color.red_50))
        }
    }
    ...
    companion object {
        ...
        fun newInstance(quizGeneral: QuizGeneral, position: Int): FeatureStepperQuizStepperFragment {
            val fragment = FeatureStepperQuizStepperFragment()
