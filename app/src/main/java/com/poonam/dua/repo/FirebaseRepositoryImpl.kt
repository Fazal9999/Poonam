...
class FirebaseRepositoryImpl @Inject constructor(
    ...
    private val userCollectionReference = db.collection(Config.USERS_COLLECTION)
    private val storageReference = storageInstance.reference
    //private val notebookCollectionReference = db.collection(Config.NOTEBOOK_COLLECTION)
            ...
            userCollectionReference
                ...
                .addSnapshotListener { value, _ ->
                    value?.forEach {
                        if (it.exists()) {
                            user = User(
                                it.getString(Config.USERNAME)!!,
                                it.getString(Config.USER_ID)!!
                            )
...
//                .whereEqualTo(Config.USER_ID, getCurrentUserId())
